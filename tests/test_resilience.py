...
class TestSearchResilience(unittest.TestCase):
    ...
    @patch("requests.get")
    def test_block_detection_raises_runtime_error(self, mock_get):
        """
        US-11: Verifies that CAPTCHAs and 429 errors are detected and raise expected errors in the loop.
        """
